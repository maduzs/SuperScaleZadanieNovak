...
import { sampleWithRequiredData } from '../task-meta.test-samples';
import { TaskMetaService } from '../service/task-meta.service';

import { TaskMetaComponent } from './task-meta.component';
import SpyInstance = jest.SpyInstance;

describe('TaskMeta Management Component', () => {
  let comp: TaskMetaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TaskMetaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taskMetas()[0]).toEqual(expect.objectContaining({ id: 30055 }));
  });

  describe('trackId', () => {
    it('Should forward to taskMetaService', () => {
      const entity = { id: 30055 };
      jest.spyOn(service, 'getTaskMetaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTaskMetaIdentifier).toHaveBeenCalledWith(entity);
