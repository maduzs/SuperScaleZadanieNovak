...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '56ac0d52-ec10-4412-a46f-49e590c6097f' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('4b232e9f-cd0e-4cf7-ba2c-6e573b7121ab');
      cy.get(`[data-cy="name"]`).should('have.value', '4b232e9f-cd0e-4cf7-ba2c-6e573b7121ab');
