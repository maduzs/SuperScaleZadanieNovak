...
describe('Task e2e test', () => {
  ...
  const taskSample = { name: 'mob aside ha', type: 'VACUUM_CLEAN' };
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="name"]`).type('yuck horde');
      cy.get(`[data-cy="name"]`).should('have.value', 'yuck horde');

      cy.get(`[data-cy="type"]`).select('VACUUM_CLEAN');
